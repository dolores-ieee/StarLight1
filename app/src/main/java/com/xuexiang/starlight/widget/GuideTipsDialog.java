package com.xuexiang.starlight.widget;
...
import com.xuexiang.starlight.core.http.api.ApiService;
import com.xuexiang.starlight.core.http.callback.NoTipCallBack;
import com.xuexiang.starlight.core.http.entity.TipInfo;
import com.xuexiang.starlight.utils.MMKVUtils;
...
public class GuideTipsDialog extends BaseDialog implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private void updateTips(List<TipInfo> tips) {
       ...
       tip.setTitle("Welcome to StarLight");
       tip.setContent("欢迎使用StarLight，我们一起开始一场心灵之旅吧~");
       showRichText(tip);
    }
